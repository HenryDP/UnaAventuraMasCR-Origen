...
export default function ConfigModal({ config, isOpen, onClose }: ConfigModalProps) {
  const { register, handleSubmit, setValue, formState: { isSubmitting } } = useForm<SiteConfig>({
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="bg-stone-100 hover:bg-stone-200 text-stone-700 px-3 py-2 rounded-lg text-xs font-bold transition-all shrink-0"
                  >
                    Subir
                  </button>
                </div>
